...
inline AttributeHook getAttributeHook() { return nullptr; }
inline void setMutationHook(MutationHook cb) { (void)cb; }
inline MutationHook getMutationHook() { return nullptr; }
} // namespace dom
