...
public:
    ...
    virtual void onAttributeChanged(dom::Element*, const std::string& name, const std::string& oldValue, const std::string& newValue) {}
...
void dom_notify_attribute_changed(dom::Element*, const std::string& name, const std::string& oldValue, const std::string& newValue);
